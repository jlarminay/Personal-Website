  ...
  <article class="p-5">
    ...
    <div class="mt-16 items-start gap-10 md:flex">
      <div class="order-2 md:w-3/5">
        <h3>Development.</h3>
        <p>
          The project was based off BattleSnake, so the idea was for the snake to have a time limit
          to get food, or they will die. I implemented a simple A* pathfinding library to allow the
          snake to find the closest food when they got hungry enough. I'm displaying the board by
          creating a table and colouring cells to the correct item. I should have done it with
          canvas items, but it was a proof of concept and I didn't know canvas that well at the
          time.
        </p>
        <p>
          Initially I was planning on just having the computer play itself, but I decided to add the
